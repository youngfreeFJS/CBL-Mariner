...
# Patch reference: https://sourceware.org/bugzilla/attachment.cgi?id=12484&action=diff&collapsed=&headers=1&format=raw
...
- Patch for glibc pthread_cond_wait missed wakeup issue.

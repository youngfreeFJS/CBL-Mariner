...
Patch0:         fix-tests-revealed-types.patch
...
%changelog
* Mon Jun 27 2022 Olivia Crain <oliviacrain@microsoft.com> - 21.4.0-2
- Add upstream patch to fix broken testAttrsGeneric* tests
